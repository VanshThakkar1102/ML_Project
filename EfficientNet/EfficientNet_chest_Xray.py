# -*- coding: utf-8 -*-
"""EfficientNet_Chest_Xray_Dataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11HUsLaCQogcXjOI6YUVZfPHDw627AyGb
"""
...
train_base_path = '/content/drive/MyDrive/Chest_Cancer_Dataset/Coronahack-Chest-XRay-Dataset/Coronahack-Chest-XRay-Dataset/train'
test_base_path = '/content/drive/MyDrive/Chest_Cancer_Dataset/Coronahack-Chest-XRay-Dataset/Coronahack-Chest-XRay-Dataset/test'
...
plt.ylabel("Actual")
plt.title("Confusion Matrix (EfficientNet - Chest X-ray)")
plt.show()
