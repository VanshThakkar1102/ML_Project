# -*- coding: utf-8 -*-
"""LeNet-5_skin_cancer_dataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DncnLTe-CnFPXNAP_EOjDVO9GVp6aOrS
"""
...
df = pd.read_csv("/content/drive/MyDrive/Skin_Cancer_MNIST_Dataset/HAM10000_metadata.csv")
df['image_path'] = df['image_id'].apply(lambda x: f"/content/drive/MyDrive/Skin_Cancer_MNIST_Dataset/HAM10000_images/{x}.jpg")
...
print(f"Final Test Accuracy (LeNet): {test_acc:.4f}")

# Predict and evaluate on datasets
